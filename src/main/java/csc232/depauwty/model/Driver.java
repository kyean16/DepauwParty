      ...
      public void run() throws IOException, InterruptedException
      {
         ...
         while(in.hasNextLine())  // infinite command line loop
         {
            ...
            if(line.equals("help") || line.equals("h"))
            {
               try
               {
                 Process p = Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler C:\\Users\\DePauw\\git\\st-group4\\CSC232F13-ST4\\Help File.doc");
                 p.waitFor();
               ...
               //Code for running program on Linux Machine
//               try             
//               {
 ...
 ///////////////////////////////////////////////////////////////////////
            ...
            else if(words.length == 4 && words[0].equals("take") && words [2].equals("from"))// Take ____ from ______
            {
               ...
               for(int i = 0; i <  state.containersInInventory.size(); i++)//Goes through the whole array of containers
               {
                  ...
                  {
                     for(int x = 0; x <  state.containersInInventory.get(i).listOfItems.size(); x++) //Looks through the items in the container 
                                                                                                     //and if found puts in the inventory and removes it from container
                     {
  ...
  /////////////////////////////////////////////////////////////          
            ...
            //Cheat code for automatically winning the game!
            else if(words.length == 2 && words[0].equals("use") && words[1].equals("gcb"))
            {
               System.out.println("You found a cheat code. By consuming the GCB, you had an amazing night and you automatically won the game!");
               break;
            }
            else
